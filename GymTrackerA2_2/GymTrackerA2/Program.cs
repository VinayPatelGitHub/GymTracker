...
namespace GymTrackerModel
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //{
            //    var thing = db.MuscleGroups.Where(c => c.MuscleGroupId == 1).FirstOrDefault();
            ...
            //using (var db = new GymTrackerContext())
            //{
            //    var thing = db.MuscleGroups.Where(c => c.MuscleGroupId == 4).FirstOrDefault();
            //    thing.MuscleGroupName = "Shoulders";
            //    db.SaveChanges();
            //}
