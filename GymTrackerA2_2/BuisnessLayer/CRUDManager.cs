...
namespace GymTrackerBusiness
{
    public class CRUDManager
    {
        ...
        public void AddExersice(string name, int muslegroupid)
        {
            using (var db = new GymTrackerContext())
            {
        ...
        public static List<string> ReadMuscleGroups()
        {
            using (var db = new GymTrackerContext())
            {
        ...
        // unsure how to get alist of specific objects, i suppose just remove from list
        // but then what's the point of linq..
        ...
        public void AddSets(int numofreps, int weight)
        {
            using (var db = new GymTrackerContext())
            {
                ...
                {
                    setnumbermanual = SelectedSet.SetNumber + 1;
                }
